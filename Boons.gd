...
var boons = {
  "zag": [
    ...
    god = "Zagreus",
    description = "Shuffle all depleted boons into the draw pile, and draw." },
    ...
    god = "Zagreus",
    description = "Dash up to @dashRange@ tiles away in one direction, passing through foes.",
