...
#bad file name, this is for both keepsakes and consumable items
...
var spawnTables = {
  ...
  "consumables": ["Hammer", "Obols", "Heart", "Pom", "Food"],
  #"shop": ["Old Collar", "Lucky Tooth", "Moly", "Eye", "Girdle", "Wind Bag", "Crit Boost", "Nail", "Blood Regen"],
...
func remove_from_spawnTable(item):  #assumes it's keepsakes for now
